...
import fortos.configuration.ObjectMapperConfiguration
...
val mainModule = module {
    ...
    single { RabbitMQGateway(get()) }

    single(named("actionProcessors")) { listOf(RabbitMQEngineProcessor(get()), LogActionProcessor()) }
